...
@Controller
public class EditFacultyAdmin {
	@RequestMapping("editfacultyadmin")
	public ModelAndView editfacultyadmin(HttpServletRequest request,HttpServletResponse response)
	{				
